...
public class ImageGridFragment extends Fragment implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
        ...
        i.putExtra("ImageId", mPhotoList.get(position-2).getmImageId());
        Log.d("ImageId",""+mPhotoList.get(position-2).getmImageId());
        if (Utils.hasJellyBean()) {
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public Object getItem(int position) {
            return position < mNumColumns ?
                    null : mPhotoList.get(position - mNumColumns).getmImagePaths();
        }
